...
function App() {
  ...
  // {`${authState.preferDark ? "dark-theme" : ""}

  return (
    <div className="dark-theme body__container">
      ...
      />
      <main className="main__container dark-theme">
        {!isMobileView_800 && (
        ...
        <section className="main__content glass-effect">
          ...
          {modalState.addModalContainer && (
            <section
              className="modal__container backdrop__container"
              id="modal"
            />
          )}
